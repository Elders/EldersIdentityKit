    ...
    func testBearerAccessTokenAuthorizerUsingBody() {
        ...
        self.performExpectation { (e) in
            ...
            authorizer.authorize(request: request, handler: { (request, error) in
                ...
                guard
                let error = error as? EldersIdentityKitError,
                case EldersIdentityKitError.authorizationFailed(let reason) = error,
                case EldersIdentityKitError.Reason.invalidContentType = reason
                else {
        ...
        self.performExpectation { (e) in
            ...
            authorizer.authorize(request: request, handler: { (request, error) in
                ...
                let error = error as? EldersIdentityKitError,
                case EldersIdentityKitError.authorizationFailed(let reason) = error,
                case EldersIdentityKitError.Reason.invalidRequestMethod = reason
                else {
