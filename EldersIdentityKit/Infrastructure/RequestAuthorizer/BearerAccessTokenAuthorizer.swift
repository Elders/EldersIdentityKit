        ...
        switch self.method {
            ...
            case .body:
                ...
                guard request.value(forHTTPHeaderField: "Content-Type") == "application/x-www-form-urlencoded" else {
                    ...
                    error = EldersIdentityKitError.authorizationFailed(reason: EldersIdentityKitError.Reason.invalidContentType)
                    return
                }
                ...
                guard let method = request.httpMethod, method != "GET" else {
                    ...
                    error = EldersIdentityKitError.authorizationFailed(reason: EldersIdentityKitError.Reason.invalidRequestMethod)
                    return
                }
            ...
            case .query:
                ...
                var components = URLComponents(url: url, resolvingAgainstBaseURL: true)
                    ...
                    error = EldersIdentityKitError.authorizationFailed(reason: EldersIdentityKitError.Reason.invalidRequestURL)
                    return
                }
