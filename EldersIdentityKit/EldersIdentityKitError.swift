...
public enum EldersIdentityKitError: LocalizedError {
    ...
    public func contains<E: Error>(error: E.Type) -> Bool {
        ...
        switch self {
            ...
            case .wrapped(let error):
                return error is E || (error as? EldersIdentityKitError)?.contains(error: E.self) == true
            
            case .general:
                return false
            
            case .authorizationFailed(let reason):
                return reason is E || (reason as? EldersIdentityKitError)?.contains(error: E.self) == true
...
extension EldersIdentityKitError {
