                ...
                Task {
                    do {
                        ...
                        DispatchQueue.main.async {
                            ...
                            handler(nil, EldersIdentityKitError.authenticationFailed(reason: error))
                        }
                    }
                    catch {
                        ...
                        DispatchQueue.main.async {
                            ...
                            handler(nil, EldersIdentityKitError.authenticationFailed(reason: EldersIdentityKitError(error: error)))
                        }
                    }
                }
            }
