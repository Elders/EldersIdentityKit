...
class AccessTokenResponseHandlerTests: XCTestCase {
    ...
    func testMissingResponseError() {
        ...
        self.performExpectation { (e) in
            ...
            e.fulfilOnThrowing(OneSoftwareIdentityKitError.Reason.unknownURLResponse, {
    ...
    func testNilDataError() {
        ...
        self.performExpectation { (e) in
            ...
            e.fulfilOnThrowing(OneSoftwareIdentityKitError.Reason.invalidAccessTokenResponse, {
    ...
    func testServerError() {
        ...
        self.performExpectation { (e) in
            ...
            e.fulfilOnThrowing(OneSoftwareIdentityKitError.Reason.unknownHTTPResponse(code: 555), {
