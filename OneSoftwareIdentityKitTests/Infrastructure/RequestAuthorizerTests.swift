    ...
    func testBearerAccessTokenAuthorizerUsingBody() {
        ...
        self.performExpectation { (e) in
            ...
            authorizer.authorize(request: request, handler: { (request, error) in
                ...
                guard
                let error = error as? OneSoftwareIdentityKitError,
                case OneSoftwareIdentityKitError.authorizationFailed(let reason) = error,
                case OneSoftwareIdentityKitError.Reason.invalidContentType = reason
                else {
        ...
        self.performExpectation { (e) in
            ...
            authorizer.authorize(request: request, handler: { (request, error) in
                ...
                let error = error as? OneSoftwareIdentityKitError,
                case OneSoftwareIdentityKitError.authorizationFailed(let reason) = error,
                case OneSoftwareIdentityKitError.Reason.invalidRequestMethod = reason
                else {
