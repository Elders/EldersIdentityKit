...
//  EldersIdentityKit-macOSTestsHost
//
...
class AuthorizationCodeGrantFlowInputViewController: NSViewController {
    ...
    @IBAction func loginAction(_ sender: Any) {
        ...
        var secret: String? = self.secretTextField.stringValue.trimmingCharacters(in: .whitespacesAndNewlines)
